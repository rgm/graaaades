...
CREATE TABLE IF NOT EXISTS "classes_tasks" (
"class_id" INTEGER REFERENCES "classes"("id") ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "special_scores" (
...
CREATE TABLE IF NOT EXISTS "task_sets_task_types" (
...
INSERT INTO sqlite_sequence VALUES('special_scores',2);
INSERT INTO sqlite_sequence VALUES('task_sets',2);
INSERT INTO sqlite_sequence VALUES('task_types',6);
